          ...
          <form class="authorization__form form" action="#" method="post">
            <div class="authorization__input-wrapper form__input-wrapper">
              <div class="form__input-section <?=(isset($form_errors["email"])) ? "form__input-section--error" : ""?>">
                <input class="authorization__input authorization__input--login form__input" type="text" name="email" placeholder="E-mail" value="<?= ($form_errors && $filter_form_data["email"]) ? $filter_form_data["email"] : '' ?>">
                <svg class="form__input-icon" width="19" height="18">
                  <use xlink:href="#icon-input-user"></use>
                </svg>
                <label class="visually-hidden">E-mail</label>
              </div>
              <span class="form__error-label form__error-label--login"><?=(isset($form_errors["email"])) ? "{$form_errors["email"]}" : ""?></span>
            </div>
            <div class="authorization__input-wrapper form__input-wrapper">
              ...
              <span class="form__error-label"><?=(isset($form_errors["password"])) ? "{$form_errors["password"]}" : ""?></span>
            </div>

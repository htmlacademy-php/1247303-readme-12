    ...
    <main>
      ...
      <div class="page__main-wrapper page__main-wrapper--intro container">
        ...
        <section class="authorization">
          ...
          <form class="authorization__form form"  method="post">
            <div class="authorization__input-wrapper form__input-wrapper">
              <input class="authorization__input authorization__input--login form__input" type="text" name="email" placeholder="E-mail">
              <svg class="form__input-icon" width="19" height="18">
                <use xlink:href="#icon-input-user"></use>
              </svg>
              <label class="visually-hidden">E-mail</label>
              <span class="form__error-label form__error-label--login">Неверный e-mail</span>
            </div>
            <div class="authorization__input-wrapper form__input-wrapper">

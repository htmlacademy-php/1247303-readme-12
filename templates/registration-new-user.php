        ...
        <div class="form__text-inputs">
          <div class="registration__input-wrapper form__input-wrapper">
            ...
            <div class="form__input-section <?=(isset($form_errors["email"])) ? "form__input-section--error" : ""?>">
              <input class="registration__input form__input" id="registration-email" type="email" name="email" placeholder="Укажите эл.почту"  value="<?= ($form_errors && $filter_form_data["email"]) ? $filter_form_data["email"] : '' ?>">
          ...
          <div class="registration__input-wrapper form__input-wrapper">
            ...
            <div class="form__input-section <?=(isset($form_errors["login"])) ? "form__input-section--error" : ""?>">
              <input class="registration__input form__input" id="registration-login" type="text" name="login" placeholder="Укажите логин" value="<?= ($form_errors && $filter_form_data["login"]) ? $filter_form_data["login"] : '' ?>">
              <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
              <div class="form__error-text">
                <h3 class="form__error-title">Данные некорректны</h3>
          ...
          <div class="registration__input-wrapper form__input-wrapper">
            ...
            <div class="form__input-section <?=(isset($form_errors["first_name"])) ? "form__input-section--error" : ""?>">
              <input class="registration__input form__input" id="registration-first_name" type="text" name="first_name" placeholder="Укажите имя" value="<?= ($form_errors  && $filter_form_data["first_name"]) ? $filter_form_data["first_name"] : '' ?>">
              <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
              <div class="form__error-text">
                <h3 class="form__error-title">Данные некорректны</h3>
          ...
          <div class="registration__input-wrapper form__input-wrapper">
            ...
            <div class="form__input-section <?=(isset($form_errors["last_name"])) ? "form__input-section--error" : ""?>">
              <input class="registration__input form__input" id="registration-last_name" type="text" name="last_name" placeholder="Укажите фамилию" value="<?= ($form_errors &&  $filter_form_data["last_name"]) ? $filter_form_data["last_name"] : '' ?>">
              <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
              <div class="form__error-text">
                <h3 class="form__error-title">Данные некорректны</h3>

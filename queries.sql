...
INSERT INTO `posts` VALUES (1, 1, 2, NULL, '2021-06-22 21:05:02', 'Цитата', 'Мы в жизни любим только раз, а после ищем лишь похожих.Мы в жизни любим только раз, а после ищем лишь похожих.', 'Неизвестный Автор', NULL, NULL, NULL, 10);
INSERT INTO `posts` VALUES (2, 2, 1, NULL, '2021-03-01 12:04:02', 'Игра престолов', 'Не могу дождаться начала финального сезона своего любимого сериала!', NULL, NULL, NULL, NULL, 12);
INSERT INTO `posts` VALUES (3, 3, 3, NULL, '2021-03-03 20:24:02', 'Наконец, обработал фотки!', NULL, NULL, 'img/rock-medium.jpg', NULL, NULL, 8);


INSERT INTO `comment` VALUES (1, '2021-03-08 13:33:43', 'Отличные фото!', 1, 3);
INSERT INTO `comment` VALUES (2, '2021-03-07 18:25:44', 'Жду, не дождусь 6-ой сезон :-)', 2, 2);

SELECT posts.text, users.login, types.title FROM `posts` LEFT JOIN `users` ON posts.user_id = users.id LEFT JOIN `types` posts.type_id = types.id order by `count_view` DESC /*Выводим список с сортировкой по популярности и вместе с именами авторов и типом контента*/
